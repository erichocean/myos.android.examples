...
include $(CLEAR_VARS)
LOCAL_MODULE := UIViewController
LOCAL_SRC_FILES := ${MYOS_PATH}/android/examples/UIKit/UIViewController/libUIViewController.so
#LOCAL_SHARED_LIBRARIES := objc icu CoreFoundation Foundation
